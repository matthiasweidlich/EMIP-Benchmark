...
| 04 | GDELT news & events | [04-gdelt-news-events/](04-gdelt-news-events/) | [dataset-04-gdelt-news-events.md](dataset-04-gdelt-news-events.md) | Samples committed; energy + unfiltered two-week tables regenerated via `build_full_tables.py` (LFS zip pending upstream) |
